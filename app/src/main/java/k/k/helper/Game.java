...
public class Game extends AppCompatActivity {
    ...
    private ArrayList<Game.ItemObject> list = new ArrayList();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(@NonNull GoogleMap googleMap) {
                Game.this.googleMap=googleMap;
                LatLng latLng = new LatLng(36.84082025252936,127.18046587264169);
                googleMap.moveCamera(CameraUpdateFactory.newLatLng(latLng));
                googleMap.moveCamera(CameraUpdateFactory.zoomTo(12));


                myItemClusterManager = new ClusterManager<MyItem>(Game.this,googleMap);
    ...
    private class Description extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                for(Element elem : mElementDataSize) {
                    ...
                    list.add(new Game.ItemObject(my_title, my_reward, my_place, my_view));
                }
        ...
        protected void onPostExecute(Void result) {
            CrawlingAdapter4 myAdapter = new CrawlingAdapter4(list);
    ...
    private void addItems(){
        double lat[] = new double[]{36.841060982327235,36.84187722467452,36.84094761097701,36.84184569039077};
        double lng[] = new double[]{127.18067384499851   ,127.18166516177315  ,127.1811556580755   ,127.18166228436095   };
        String name[] = new String[]{"게임스토리pc방","와우pc방","메이크엠박스노래방","스타싱어코인노래연습장"};
