...
public class House extends AppCompatActivity {
    ...
    private ArrayList<House.ItemObject> list = new ArrayList();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(@NonNull GoogleMap googleMap) {
                House.this.googleMap=googleMap;
                LatLng latLng = new LatLng(36.84082025252936,127.18046587264169);
                googleMap.moveCamera(CameraUpdateFactory.newLatLng(latLng));
                googleMap.moveCamera(CameraUpdateFactory.zoomTo(12));


                myItemClusterManager = new ClusterManager<MyItem>(House.this,googleMap);
    ...
    private class Description extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(House.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                for(Element elem : mElementDataSize) {
                    ...
                    list.add(new House.ItemObject(my_title, my_reward, my_place, my_view));
                }
        ...
        protected void onPostExecute(Void result) {
            CrawlingAdapter5 myAdapter = new CrawlingAdapter5(list);
